...
- **`.github/agents/`** — Agent definitions (this file)
- **`.github/skills/`** — Skill definitions for each step
- **`example-docs/capacity-strategy/`** — Example/reference files showing expected input and output formats
  - `platform-context.md` — Sample platform context file
  - `workflow-telemetry-baseline.csv` — Sample workflow telemetry data from KQL query
- **`../../../../../wiki/capacity-strategy/`** — Runtime output location (outside this repo)
  - `context/` — Runtime platform context copy
  - `01-assessments/`, `02-recommendations/`, etc. — Strategy document outputs
...
1. Read `../../../../../wiki/capacity-strategy/context/platform-context.md` (copy from ai-engineer repo or create there).
...
6. Create or confirm the wiki folder structure exists: `../../../../../wiki/capacity-strategy/{context,01-assessments,02-recommendations,03-plans,04-distribution,05-governance,06-risks-gaps,07-compiled}/`
